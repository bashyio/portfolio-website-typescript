...
export const sectionStyles = (theme: Theme, background, color) =>
  css`
    display: block;
...
export const containerStyles = (theme: Theme, fullWidth, background, color) =>
  css`
    display: block;
    background: ${background};
    color: ${color};
...
export const rowStyles = (theme: Theme, background, color) =>
  css`
    display: block;
    background: ${background};
    color: ${color};
...
export const spacingStyles = (theme: Theme, size) =>
  css`
    display: block;
    width: 100%;
